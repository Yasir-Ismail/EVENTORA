...
<section class="page-header">
    <div class="container">
        <h1>Our Services</h1>
        <p>Explore our professional event planning services</p>
    </div>
</section>
        ...
        <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card service-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="book_event.php" class="btn btn-purple btn-sm mt-2">Book This Service</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    ...
                    <p class="text-muted">Check back soon for our event services.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<section class="cta-section">
    <div class="container">
        ...
        <p>Contact us to discuss your unique event requirements.</p>
        <a href="book_event.php" class="btn btn-eventora btn-lg">Get in Touch</a>
    </div>
</section>
